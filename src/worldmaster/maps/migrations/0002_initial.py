...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name='presence',
            constraint=models.CheckConstraint(check=worldmaster.maps.functions.IsClosed(models.F('shape')), name='shape_must_be_closed', violation_error_message='Polyhedral shapes must be closed.'),
        ),
    ]
